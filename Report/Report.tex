...
\begin{figure}[H]
    \centering
    \subfloat[\centering ELO Game Simulation]{{\includegraphics[width=7.5cm]{ELO_Game_Sim.png}}}
    \qquad
    \subfloat[\centering ELO Probabilistic Simulation]{{\includegraphics[width=7.5cm]{ELO_Time_SIM.png}}}
    \caption{Santorini}
    \label{fig:}
\end{figure}
